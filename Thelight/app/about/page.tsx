...
export default function AboutPage() {
  return (
    <main>
      ...
      <section className="section-shell">
          <div className="page-shell flex flex-col min-[992px]:flex-row items-start gap-[40px]">
            <div className="w-full min-[992px]:w-[40%] min-[992px]:sticky min-[992px]:top-[120px]">
              <AnimatedSection xOffset={-50}>
                <div className="about-sticky-media-card rounded-[20px] overflow-hidden">
                  <Image
                    src="/images/tobi.jpg"
                    alt="Tobi Adebayo portrait"
                    width={800}
                    height={1100}
                    className="about-sticky-image w-full h-auto object-cover"
                    priority
                  />
                </div>
              </AnimatedSection>
            ...
            <AnimatedStaggerGroup className="section-gap-30 w-full min-[992px]:w-[60%]">
